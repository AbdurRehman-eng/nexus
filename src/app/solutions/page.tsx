        ...
        <section className="bg-gradient-to-br from-dark-red to-maroon text-white py-16 sm:py-20 md:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 text-center">
            ...
            <p className="text-lg sm:text-xl text-red-100 max-w-2xl mx-auto">
              Whether you're a startup or an enterprise, NEXUS scales with your needs
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-dark-red transition-colors">
                ...
                <h3 className="text-2xl font-bold mb-4 text-gray-900">For Small Teams</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Perfect for startups and small teams looking to streamline communication and boost productivity.
                </p>
              ...
              <div className="bg-gradient-to-br from-dark-red to-maroon text-white rounded-lg p-8 relative overflow-hidden">
                ...
                <p className="text-red-100 mb-6 leading-relaxed">
                  Advanced features and dedicated support for large organizations with complex needs.
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-white">Advanced security & compliance</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-white mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-white">Custom integrations & API access</span>
                  </li>
                </ul>
                <Link href="/contact" className="bg-white text-dark-red hover:bg-gray-100 font-semibold px-6 py-3 rounded-button w-full text-center block transition-colors">
                  Contact Sales
                </Link>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-bold text-gray-900 mb-2">Real-time Messaging</h3>
                <p className="text-sm text-gray-600">Instant communication with threaded conversations</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-bold text-gray-900 mb-2">HD Video Calls</h3>
                <p className="text-sm text-gray-600">Crystal clear video with screen sharing</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-bold text-gray-900 mb-2">File Management</h3>
                <p className="text-sm text-gray-600">Easy file sharing and organization</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-bold text-gray-900 mb-2">Search & AI</h3>
                <p className="text-sm text-gray-600">Intelligent search across all content</p>
              </div>
            </div>
          </div>
        </section>
