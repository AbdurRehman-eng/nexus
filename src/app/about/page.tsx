        ...
        <section className="py-16 sm:py-20 md:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-8 text-center">
              At NEXUS, we believe that effective collaboration should be
              simple, powerful, and accessible to everyone. Our mission is to
              provide teams with the tools they need to communicate seamlessly,
              work efficiently, and achieve their goals together.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Making teamwork effortless and productive for teams of all
                  sizes.
                </p>
              </div>
