    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <h1 className="text-5xl font-bold bg-gradient-to-r from-[#4A0808] to-[#3A506B] bg-clip-text text-transparent mb-6">
              Get in Touch
            </h1>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    shafiqueabdurrehman1@gmail.com
                  </p>
                </div>
              </div>
          ...
          <div className="card">
            <h2 className="text-2xl font-bold text-[#1C2143] mb-6">
              Send us a Message
            </h2>
                ...
                <div>
                  ...
                  {formData.message.length > 5000 && (
                    <p className="mt-1 text-xs text-red-600">
                      Message exceeds maximum length. Please shorten your
                      message.
                    </p>
                  )}
                </div>
